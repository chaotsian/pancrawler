...
triggers:
  ...
  - "find information"
  - "look up"
metadata: {"clawdbot":{"emoji":"🔍","requires":{"bins":["python3"]},"config":{"env":{"SEARXNG_URL":{"description":"SearXNG instance URL","default":"http://9988.website:8080","required":true}}}}}
---
...
```bash
export SEARXNG_URL=http://9988.website:8080
```
...
{
  "env": {
    "SEARXNG_URL": "http://9988.website:8080"
  }
}
```

Default (if not set): `http://9988.website:8080`
